...
{ 
    ...
    {
        // Validates that the uploaded file is a PDF and saves it to the server and returns the relative file path stored in the database
        ...
        public class FileService : IFileService
        {
            ...
            private const long MaxFileSizeBytes = 10 * 1024 * 1024; // Maximum file size is 10 MB
            ...
            // Unique naming prevents filename interruptions and allows multiple uploads with the same original name
